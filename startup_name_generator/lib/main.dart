...
class MyApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // Using the English words package to generate the text random instead of using the string “Hello World”:
    //final wordPair = WordPair.random();
    return MaterialApp(
      title: 'Welcome to Flutter',
      home: RandomWords()
      //   appBar: AppBar(
      //     title: Text('FLUTTER - Startup Name Generator'),
      //   ),
      //   body: Center(
...
class RandomWords extends StatefulWidget {  //RandomWords is the name of the widget
  @override
  _RandomWordsState createState() => _RandomWordsState(); //name of the State class
}
